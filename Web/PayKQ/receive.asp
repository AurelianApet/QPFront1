...
If UCase(signMsg)=UCase(merchantSignMsg) then
	...
	Select Case payResult	      
		  case "10"
			...
			rtnOk=1
			rtnUrl="http://baisheng1818.com/PayKQ/show.asp?msg=success!"
			'在线充值
			Call CxGame.OnlinePay(orderId,ext1)
		 Case else

			rtnOk=1
			rtnUrl="http://baisheng1818.com/PayKQ/show.asp?msg=false!"
	...
	rtnOk=1
	rtnUrl="http://baisheng1818.com/PayKQ/show.asp?msg=error!"
