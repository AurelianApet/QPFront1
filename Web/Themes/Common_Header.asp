...
<div class="main">
	<div class="top">
		<div class="left"><img src="images/logo.gif"/><font color="#FF0000" size="+1"><b> </b></font></div>
		<div class="right mtop13 lan">
			<ul>
 
		    <li class="top1"><a id="A1" href="javascript:void(0);" onclick="setHomepage('http://baisheng1818.com')" class="ll" >设为首页</a></li>
		    <li class="top2"><a href="Sitemap.asp" class="ll">网站地图</a></li>
		    <li class="top3"><a href="javascript:void(0);" onclick="addFavorites('http://baisheng1818.com','开心游戏棋牌 - 游戏融入生活，快乐无处不在')" class="ll">加入收藏</a></li>
		    </ul>
			<div class="clear"></div>
		</div>
	</div>
