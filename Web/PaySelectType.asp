					...
					<div class="err mtop13">请填写要充值的用户名：</div><br /><br />
						...
						<div class="userBox1 right">
							<div class="cardBox1">
								...
								<label>购买价格：10元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;会员时间：30天<br/>赠送金币：1000&nbsp;&nbsp;&nbsp;赠送会员：黄钻</label>
							<div class="clear"></div>
							</div>
						</div>
						<% End If %>
						...
						<div class="userBox1 right">
							<div class="cardBox1">
								...
								<label>购买价格：60元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;会员时间：180天<br/>赠送金币：6000&nbsp;&nbsp;&nbsp;赠送会员：蓝钻</label>
							<div class="clear"></div>
							</div>
						</div>
						<% End If %>
						...
						<div class="userBox1 right">
							<div class="cardBox1">
								...
								<label>购买价格：120元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;会员时间：360天<br/>赠送金币：12000&nbsp;&nbsp;&nbsp;赠送会员：红钻</label>
							<div class="clear"></div>
							</div>
						</div>
						<% End If %>
